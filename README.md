...
Quick reason(s) why this pipeline is cool.
...
```shell
$ git clone https://github.com/xguse/cool-pipeline-name.git
```

Or via downloading a [zip](https://github.com/xguse/cool-pipeline-name/archive/master.zip) of the repository via the project's [github page](https://github.com/xguse/cool-pipeline-name).
